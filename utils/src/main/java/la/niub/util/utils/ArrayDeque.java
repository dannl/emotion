                           ...
                           implements Deque<E>, Cloneable, Serializable
{
    ...
    private void checkInvariants() {
        Log.myAssert(elements[tail] == null);
        Log.myAssert(head == tail ? elements[head] == null : (elements[head] != null && elements[(tail - 1) & (elements.length - 1)] != null));
        Log.myAssert(elements[(head - 1) & (elements.length - 1)] == null);
    }
